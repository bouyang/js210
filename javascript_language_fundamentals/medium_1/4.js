...
// In both loops, the length variable is declared as var which has function scope so when JS looks for its value
// on line 4, it assigns it to numbers.length
// On line 5, length is reassigned to the inner loop's cols.length value which is used in the loop on line 4, so
// the outer loop only executes based on the number of cols